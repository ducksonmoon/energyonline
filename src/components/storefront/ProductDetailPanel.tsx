        ...
        <div className="p-5 lg:px-8 lg:py-7 lg:grid lg:grid-cols-2 lg:gap-10 lg:items-start">
          <div className="lg:sticky lg:top-[76px]">
            <div
              ...
              style={{
                background: product.images[galleryIndex]
                  ? undefined
                  : "linear-gradient(155deg, var(--bg-alt), #ddd4c4)",
              }}
            >
          ...
          <div className="text-center text-[11px] text-[var(--ink-soft)] mt-2.5">
            فقط موجودی فروشگاه، تعداد محدود
          </div>
          </div>
        </div>
      </motion.div>
