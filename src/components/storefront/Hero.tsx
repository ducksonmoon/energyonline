...
export function Hero({ heroStockLine, heroTags }: { heroStockLine: string; heroTags: HeroTag[] }) {
  ...
  return (
    <div className="px-5 pt-8 pb-2 sm:pt-11 max-w-[640px] mx-auto text-center flex flex-col items-center gap-2.5">
      ...
      <div
        ...
        className="mt-3 w-full max-w-[280px] h-[170px] relative"
